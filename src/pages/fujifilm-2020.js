    ...
    <>
      <Post>
        ...
        <PostBody>
          ...
          <p>
            파티클이 떨어지는 모션은 원래 디자인에는 없었는데 파티클이 점점 커지며 화면을 덮는 모션의 연결성을 극대화하고자 넣었습니다. 다행히 반응이 좋아 기획자와 디자이너의 동의를 얻어 페이지에 적용하기로 했습니다. 사실 이때 굉장히 기뻤는데 화면 개발자로서 생각하고 구현한 것이 디자인 요소에 반영되었기 때문이었죠.
          </p>
          <p>
